...
const Projects = () => {
  ...
  return (
    <section id="services" className="flex flex-col gap-8 p-8 md:p-20">
      ...
      <div className="grid gap-8 md:grid-cols-12">
        <div className="counter light-cream sticky top-20 col-span-5 hidden h-min justify-center text-[10rem] md:flex">
          {counter}
        </div>
